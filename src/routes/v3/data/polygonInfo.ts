...
// route path will be appended to end of file structure (v3/data/polygon-info)
router.post("/",
    requiredFields(['polygon_data_id', 'request_time']),
    ...
    async (req, res) => {
        ...
        const DbRes = await db.query(
            `
                INSERT INTO polygon_data_info 
                    (polygon_data_id, description, evac_notice, additional_info, created_by_user_id, last_edited_by_user_id, created_time, last_edited_time)
                VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
                RETURNING polygon_data_info_id;
            `,
            [
