...
// route path will be appended to end of file structure (v3/data/point-info)
router.post("/", 
    requiredFields(['point_data_id', 'request_time']),
    ...
    async (req: Request, res: Response) => {
        ...
        const DbRes = await db.query(
            `INSERT INTO point_data_info 
            (point_data_id, description, evac_notice, additional_info, created_by_user_id, last_edited_by_user_id, created_time, last_edited_time)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
            RETURNING point_data_info_id;`,
            [
                json["point_data_id"],
                json["description"],
                json["evac_notice"],
